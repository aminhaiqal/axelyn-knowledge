  ...
  return (
    <AdminShell operator={operator} workspace={workspace}>
      ...
      <div className="content-width">
        ...
        <div className="data-table-wrap">
          {result.items.length ? (
            ...
            <div className="empty-state">
              ...
              Clear a filter or add new source material.
            </div>
          )}
        </div>
        {result.next_cursor ? (
        ...
        <details className="panel advanced-entry" style={{ marginTop: 36 }}>
          <summary>Add one exact atomic statement instead</summary>
          <div className="advanced-entry-content">
